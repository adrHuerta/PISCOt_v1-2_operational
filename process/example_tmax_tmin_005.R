...
source('./src/005/Merging/MG_make_covariables.R')
source('./src/005/Merging/MG_RK.R')
...
LST_day <- raster::brick("data/covariables/005/LST_DAY.nc")
LST_night <- raster::brick("data/covariables/005/LST_NIGHT.nc")
DEM <- raster::raster("data/covariables/005/DEM.nc")
X <- raster::raster("data/covariables/005/X.nc")
Y <- raster::raster("data/covariables/005/Y.nc")
tdi <- raster::raster("data/covariables/005/TDI.nc")

# gridded (climatologies)
tmax_normals <- raster::brick("data/climatologies/tmax_mean_1981-2010_005.nc") 
tmin_normals <- raster::brick("data/climatologies/tmin_mean_1981-2010_005.nc")
